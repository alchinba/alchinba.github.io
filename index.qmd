...
resources: Dimash Alchinbayev Resume.pdf
about: 
  template: solana
  image-shape: round
  image-width: 12em
  links: 
    ...
    - text: Resume
      icon: file-text
      href: Dimash Alchinbayev Resume.pdf
    - text: Projects
      icon: graph-up-arrow
      href: projects.qmd
---
...
I am an economic research and public policy analyst with extensive experience in working with quantitative and qualitative data. Enjoy learning new skills and creative and efficient problem solving. Proven to be a responsible and detail-oriented person, as demonstrated by my academic and work experience.
...
GPA: 3.6; Honors Scholar

## RELATED COURSES

Machine Learning Algorithms; Econometrics; Economic Forecasting; AI Software Tools; Market Research and Data Analysis; 

Statistics and Probability; Linear Algebra and Differential Equations; Multivariable Calculus;

Financial Economics; Public Finance; Politics and Data Analysis; Managerial Economics; Intermediate Micro Theory; Intermediate Macro Theory; Measuring Business Cycles; Operations Research; Philosophy of Law; Political Economy
...
- Composed literature reviews on the latest academic and business progress in digitalization of agricultural finance and its effects.
...
**Software**: R, Stata, Excel, PowerPoint, SQL, Python, Tableau, Git, LaTeX

**Hard**: Machine Learning, Statistical data analysis, Data Manipulation; Data Visualization

**Soft**: Literature Review; Presenting; Communication; Teamwork; Problem Solving; Analytical Thinking; Fast Learning; Accuracy
